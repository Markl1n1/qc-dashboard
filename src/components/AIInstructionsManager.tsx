    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <Alert>
          ...
          <AlertDescription>
            Upload .txt files containing system instructions for AI analysis. The latest file will be used automatically. Maximum 10 files are stored with automatic rotation.
          </AlertDescription>
        </Alert>
                ...
                <div key={file.name} className="flex items-center justify-between p-2 border rounded">
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-muted-foreground mt-1">
                      Uploaded: {formatDate(file.created_at)} • Size: {formatFileSize(file.size)}
                    </div>
                  </div>
                  <Button
                    variant="ghost"
